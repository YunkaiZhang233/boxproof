...
\textbf{Don't insert extra blank lines as this breaks the proofs!} If you really need actual blank lines, use \verb/\\/.
...
\begin{itemize}
  ...
  \item \verb/\forallintro/ for $\forallintro$, \verb/\forallelim/ for $\forallelim$
...
Here are some exemplar natural deduction proofs rendered with this modified package, taken from unassessed PMT exercises. You can find the source code in the tex file.
